...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const res = await fetch(
      `${api_url}update/profile/${user._id}`, // ✅ FIX
      {
        method: 'PUT',
        headers: {
  ...
  const inputClass = "w-full border rounded-md mt-1 focus:ring-2 focus:ring-blue-500 focus:outline-none px-3 py-2 text-sm md:px-4 md:py-2 md:text-base";
