      ...
      >
        <div className="flex flex-col md:flex-row gap-4">
          <img
            ...
            width={192}
            height={128}
            className="w-full md:w-48 h-48 md:h-32 rounded-lg object-cover cursor-pointer"
            loading="lazy"
            onError={(e) =>
        ...
        <div className="border-t mt-4 pt-3 flex flex-col md:flex-row justify-between gap-3 text-sm text-[#441A6B]">
          <div className="flex flex-col md:flex-row gap-3 w-full">
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
              <div className="p-4 sm:p-6 max-w-full sm:max-w-md mx-auto">
        ...
        {selectedImage && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50 p-4 sm:p-0">
            <div className="relative bg-white rounded-lg w-full max-w-2xl mx-auto">
              <button
