          ...
          {!loading && (
            <>
              ...
              <div className="md:hidden space-y-4">
                {/* Tab switcher */}
                <div className="relative flex w-full bg-white border rounded-full shadow-md overflow-hidden" style={{ borderColor: colors.accent.red }}>
                  <div
                    className="absolute top-0 left-0 h-full rounded-full transition-transform duration-500 ease-in-out z-0"
                    style={{
                  ...
                  {currentList.map((item, index) => {
                    ...
                    return (
                      <button
                        ...
                        `}
                        style={{
                          borderColor: isSelected ? colors.accent.red : colors.accent.orange + '50',
                          backgroundColor: isSelected ? colors.accent.orange + '20' : 'white'
                        }}
                      >
                        <span
                        ...
                        <span
                          className={`text-xs font-semibold whitespace-nowrap ${isSelected ? "" : "text-gray-700"}`}
                          style={isSelected ? { color: colors.accent.red } : {}}
                        >
                          {item.name}
                        </span>
                        {isSelected && (
                          <span className="text-[9px] font-medium whitespace-nowrap" style={{ color: colors.accent.red }}>
                  ...
                  <div className="rounded-2xl border border-orange-100 bg-white/95 shadow-lg p-4 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="shrink-0 text-white rounded-full px-4 py-2 text-xs font-semibold shadow"
                    ...
                    <Link
                      href="/contactUs"
                      className="flex items-center justify-center w-full rounded-full py-2 text-xs font-semibold hover:bg-[#fff7ed] transition"
                      style={{
              ...
              <div className="hidden md:block">
                <div className="flex justify-center mb-8">
                  <div className="relative flex w-full max-w-md bg-white border rounded-full shadow-md overflow-hidden" style={{ borderColor: colors.accent.red }}>
                    <div
                      className="absolute top-0 left-0 h-full rounded-full transition-transform duration-500 ease-in-out z-0"
                      style={{
                        width: `calc(100% / ${tabs.length})`,
                ...
                <div className="mx-auto flex max-w-7xl items-start gap-8">
                      ...
                      {currentList.map((item, index) => {
                        ...
                        return (
                          <button
                            ...
                            style={{
                              borderColor: isSelected ? colors.accent.red : undefined,
                              backgroundColor: isSelected ? colors.accent.orange + '20' : undefined
                            }}
                          >
                            <div
                  ...
                  <div className="h-120 min-w-0 flex-1 rounded-4xl border border-gray-200 bg-white/95 p-8 space-y-6 overflow-hidden">
                    {selectedItem ? (
                      <>
                        ...
                        <div className="flex gap-4 flex-wrap">
                          <Link
                            href={buildHref(selectedItem)}
                            className="text-white px-6 py-2 rounded-full shadow"
                            style={{ backgroundColor: colors.accent.red }}
                          >
                            View Colleges
                          </Link>
