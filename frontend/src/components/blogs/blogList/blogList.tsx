...
export default function BlogList() {
  ...
  return (
    <section className="container-1 mx-auto px-4 sm:px-6 py-10 sm:py-[70px] bg-white">
      <h2 className="font-extrabold text-center text-gray-900 mb-6 sm:mb-8
      ...
      {loading && (
        <>
          ...
          <div className="hidden sm:grid mt-12 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[0,1,2,3].map(i => (
                  ...
                  <article className="flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-[0_18px_40px_rgba(62,44,92,0.15)] mx-0.5">
                    ...
                    <div className="flex flex-col gap-2 p-4">
                      ...
                      <Link
                        ...
                        className="mt-1 inline-flex items-center gap-1 text-xs font-semibold text-[#c25541] hover:gap-2 transition-all"
                      >
