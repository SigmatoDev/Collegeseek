          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="bg-[#FFF7ED] p-3 rounded-xl">
                <Phone className="text-[#D17563]" size={24} />
              </div>
              <div>
                <h4 className="text-[#D17563] font-semibold text-lg">Call Us</h4>
            ...
            <div className="flex items-start gap-4">
              <div className="bg-[#FFF7ED] p-3 rounded-xl">
                <Mail className="text-[#D17563]" size={24} />
              </div>
              <div>
                <h4 className="text-[#D17563] font-semibold text-lg">Email</h4>
            ...
            <div className="flex items-start gap-4">
              <div className="bg-[#FFF7ED] p-3 rounded-xl">
                <MapPin className="text-[#D17563]" size={24} />
              </div>
              <div>
                <h4 className="text-[#D17563] font-semibold text-lg">Visit Us</h4>
